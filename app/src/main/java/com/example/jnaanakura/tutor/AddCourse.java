package com.example.jnaanakura.tutor;
...
import com.example.jnaanakura.AddVideoActivity;
...
public class AddCourse extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String[] courses = {"Carnatic Music", "Western Instruments", "Art", "Bharathanatyam", "Other1", "Other2"};
